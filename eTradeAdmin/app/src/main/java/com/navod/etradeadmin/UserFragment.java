...
import com.navod.etradeadmin.service.UserService;
...
public class UserFragment extends Fragment {
    ...
    private void setRecyclerView(){
        ...
        getUsers(new GetUserListCallback() {
            @Override
            public void onSuccess(List<User> userList) {
                Log.i(TAG, userList.toString());
                UserViewAdapter userViewAdapter = new UserViewAdapter(getContext(), userList);
    ...
    private void getUsers(GetUserListCallback callback){
        userService.getUserList(Collections.emptyMap(), new GetUserListCallback() {
            @Override
            public void onSuccess(List<User> userList) {
                Log.i(TAG, userList.toString());
    ...
    private void initViews(View fragment){
        ...
        recyclerView = fragment.findViewById(R.id.userRecyclerView);
    }
}