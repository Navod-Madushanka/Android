 ...
 * Use the {@link Computers#newInstance} factory method to
...
public class Computers extends Fragment {
    ...
    public static Computers newInstance(String param1, String param2) {
        Computers fragment = new Computers();
    ...
    private void setDataToRecyclerView(View fragment){
        ...
        conditions.add(Pair.of("category", "Computer"));
