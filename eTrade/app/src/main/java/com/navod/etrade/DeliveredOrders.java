...
public class DeliveredOrders extends Fragment {
    ...
    private static final String TAG = DeliveredOrders.class.getName();
     ...
     * @return A new instance of fragment DelieverdOrders.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_delieverd_orders, container, false);
    }
    ...
    private void getData(GetOrderCallBack callBack){
        ...
        condition.put("orderStatus", Arrays.asList(OrderStatus.DELIVERED, OrderStatus.CANCELED));
    ...
    private void setAdapter(){
        getData(new GetOrderCallBack() {
            ...
            public void onSuccess(List<com.navod.etrade.entity.Order> orderList) {
                ...
                deliveredOrdersRecyclerView.setLayoutManager(linearLayoutManager);
                OrderRecyclerViewAdapter orderRecyclerViewAdapter = new OrderRecyclerViewAdapter((Order) getActivity(), orderList);
                deliveredOrdersRecyclerView.setAdapter(orderRecyclerViewAdapter);
            }
    ...
    private void initViews(View fragment){
        ...
        deliveredOrdersRecyclerView = fragment.findViewById(R.id.deliveredOrderRecyclerView);
    }
}