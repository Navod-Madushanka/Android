package com.navod.firebaseauth;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnOneTapSignIn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BeginSignInRequest oneTapReuqst = BeginSignInRequest.builder().setGoogleIdTokenRequestOptions(BeginSignInRequest
                ...
                Task<BeginSignInResult> beginSignInResultTask = signInClient.beginSignIn(oneTapReuqst);
